...
import { getProducts } from "@/app/auth/callback/actions";
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Track prices across thousands of products and get instant alerts
            when they drop. Say goodbye to manual price checks and hello to
